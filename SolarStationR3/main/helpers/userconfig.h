...
void loadConfiguration()
{
    ...
    CFG_LOAD_INT("station.power_saving", DEFAULT_STATION_POWER_SAVING);
    ...
    CFG_LOAD_STR("http.update_url", DEFAULT_HTTP_UPDATE_URL);
    CFG_LOAD_STR("http.update_username", DEFAULT_HTTP_UPDATE_USERNAME);
    CFG_LOAD_STR("http.update_password", DEFAULT_HTTP_UPDATE_PASSWORD);
    CFG_LOAD_INT("http.update_timeout", DEFAULT_HTTP_UPDATE_TIMEOUT);
    CFG_LOAD_INT("http.update_interval", DEFAULT_HTTP_UPDATE_INTERVAL);
